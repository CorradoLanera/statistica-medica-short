...
Per me: [Discrete](https://app.wooclap.com/events/STATMEDDISCRETE/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-discrete.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-discrete](https://bit.ly/statmed-sondaggio-discrete)
...
L’**atteso** $E(X)$ (o $\mu$) è la media dei valori di $X$: somma pesata nel discreto, integrale nel continuo

$$E(X)=\int_{-\infty}^{\infty} x f(x)\,dx.$$

La **varianza** $\text{Var}(X)$ (o $\sigma^2$) è la media dello scarto quadratico dall’atteso:

$$\text{Var}(X)=\int_{-\infty}^{\infty} (x-E[X])^2 f(x)\,dx.$$

La **deviazione standard** è $\sqrt{\text{Var}(X)}$.

La **moda** è il punto di densità massima

La **mediana** divide in due la distribuzione, ovvero $P(X\leq m)=\frac{50}{100}=\frac{1}{2}$.

I **percentili** generalizzano quest’idea, ovvero $P(X\leq p_k)=\frac{k}{100}$.

---

<img src="img/mode-med-mean-normal-dist.png"/>

---

# .orange[Parametri] vs .orange[Statistiche]

| Simbolo | Nome                   | Popolazione             | Campione                    |
|---------|------------------------|-------------------------|-----------------------------|
| $\mu$   | Valore atteso / media  | centro teorico          | $\bar{x}$ = media campionaria |
| $\sigma^2$ | Varianza             | variabilità teorica     | $s^2$ = varianza campionaria|
| $\sigma$   | Deviazione standard | disp. media teorica     | $s$ = dev. std. campionaria |

- **Parametri** ($\mu$, $\sigma^2$, $\sigma$): grandezze vere della popolazione (in genere ignote).  

- **Statistiche** ($\bar{x}$, $s^2$, $s$): stime calcolate dai dati campionari.
...
Per me: [Continue](https://app.wooclap.com/events/STATMEDCONTINUE/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-continue.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-continue](https://bit.ly/statmed-sondaggio-continue)
...
La distribuzione normale è definita dalla sua distribuzione di densità di probabilità:


---
# Distribuzione Normale:<br>.orange[parametri]
...
---
# Distribuzione Normale:<br>.orange[forma]
...
La distribuzione cumulativa per $N(0, 1)$ è indicata da $\Phi(x) = P(X\leq x)$
...
La cumulata $\Phi(x)$ può aiutare a calcolare le probabilità di una $N(0,1)$

Trovare (non _calcolare_) $P(X \leq 1.96)$ e $P(X \leq 1)$... cerco i valori nelle tavole:
...
Per me: [Normale](https://app.wooclap.com/events/STATMEDNORMALE/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-normale.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-normale](https://bit.ly/statmed-sondaggio-normale)
...
# .center[**.orange[Approssimazioni]** alla distribuzione normale<br><br>(OPZIONALE - no esame)]
