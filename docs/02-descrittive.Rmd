...
- la $(\frac{N+1}{2})$-ma osservazione se $N$ è dispari (ovvero, **ha un centro**)
  > Se prendo $k$ il più grande numero intero che non sia più grande di $N/2$, è la $k+1$-esima osservazione
  
- la media aritmetica della $(\frac{N}{2})$-ma e la $(\frac{N}{2}+1)$-ma
osservazione se $N$ è pari (ovvero, **non ha un centro**)
  > Se prendo $k$ il più grande numero intero che non sia più grande di $N/2$, è la media tra la $k$-esima e la $k+1$-esima osservazione
