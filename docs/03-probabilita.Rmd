...
La formula "tradizionale" frequentista per VPN (analoga VPN)

$$VPP = \frac{VP}{VP + FP}$$

Dove $VP$ è il numero di veri positivi (numero di volte che il test ha dato esito positivo correttamente) e $FP$ il numero di falsi positivi (numero di volte che il test ha dato esito positivo erroneamente). Questo, dunque, ipotizzando di avere il dato certo del numero di veri e falsi positivi. 

Noi usiamo quella bayesiana, perchè:

- esprime e mostra  bene il concetto di probabilità condizionata

- opera un cambio di prospettiva: dal controllo dell'incertezza su una _predizione_ sul futuro, rispetta a una descrizione statica definita di dati già osservati.
