...
subtitle: "Intervalli di Confidenza e p-value"
...
$$\begin{split}\mbox{var}(\bar{X})&= \mbox{var}\left(\frac{\sum_{i=1}^n X_i}{n}\right) =* \frac{1}{n^2} \mbox{var}\left(\sum_{i=1}^n X_i\right) =* \frac{1}{n^2} \sum_{i=1}^n \mbox{var}(X_i)\\& \stackrel{\mbox{def}}{=} \frac{1}{n^2} \sum_{i=1}^n\sigma^2 = \frac{1}{n^2} n\sigma^2 = \frac{\sigma^2}{n}\end{split}$$


- $\frac{\sigma}{\sqrt{n}}$ è chiamato con .orange[errore standard della media], stimato da $\frac{s}{\sqrt{n}}$


$$*)\begin{split}\mbox{var}(aX) &= \frac{\sum_1^n\left(ax_i-\frac{\sum_1^nax_j}{n}\right)^2}{n}= \frac{\sum_1^n\left(ax_i-\frac{a\sum_1^nx_j}{n}\right)^2}{n}\\&= \frac{\sum_1^n\left(a\left(x_i-\mu\right)\right)^2}{n}= \frac{\sum_1^na^2\left(x_i-\mu\right)^2}{n}\\&=\frac{a^2\sum_1^n\left(x_i-\mu\right)^2}{n}=a^ 2\mbox{var}(X)\end{split}$$ 
...
Per me: [Stimatore della media](https://app.wooclap.com/events/STATMEDTLC/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-tlc.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-tlc](https://bit.ly/statmed-sondaggio-tlc)
...
Per me: [Intervalli di Confidenza](https://app.wooclap.com/events/STATMEDICP/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-icp.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-icp](https://bit.ly/statmed-sondaggio-icp)
...
Per me: [Distribuzione t-Student](https://app.wooclap.com/events/STATMEDTSTUDENT/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-tstudent.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-tstudent](https://bit.ly/statmed-sondaggio-tstudent)
...
$$c=120-1.645\frac{25}{10}=115.89$$

quindi, poiché $\bar{X}=115<115.89=c$ si rifiuta $H_0$ ad un livello di significatività di 0.05
...
$$c=120-2.326\frac{25}{10}=114.18$$

e quindi **non si rifiuterebbe** l'ipotesi nulla dal momento che $\bar{x}=115\geq 114.18=c$
...
si può anche equivalentemente calcolare
...
$$P(Z\leq c_1|H_0)=P(Z\geq c_2|H_0)=\frac{\alpha}{2}$$
...
Si considera quindi un campione di 100 donne con le caratteristiche specificate e si osserva un livello di colesterolo medio pari a $181.52\ mg/dL$. Si testa quindi l'ipotesi 
...
Se $X_1,...,X_n$ è un campione di osservazioni indipendenti distribuite normalmente $N(\mu,\sigma^2)$, allora la quantità $\frac{\bar{X}-\mu_0}{\frac{s}{\sqrt{n}}}$ è distribuita seconda una $t$ di Student con $n-1$ gradi di libertà.
...
Per me: [p-value](https://app.wooclap.com/events/STATMEDPVALUE/0)

Per voi: <img src="img/bit.ly_statmed-sondaggio-pvalue.png", width="300px" style="vertical-align: middle"/> [bit.ly/statmed-sondaggio-pvalue](https://bit.ly/statmed-sondaggio-pvalue)
